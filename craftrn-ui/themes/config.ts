export const colors = {
  ...
  secondaryLight: '#1D6E7A',
  secondaryLightPress: '#155A64',
  secondaryLightContainer: '#E8F6F8',
  onSecondaryLight: '#ffffff',
  onSecondaryLightContainer: '#1D6E7A',

  secondaryDark: '#69D6E8',
  secondaryDarkPress: '#9CEFFF',
  secondaryDarkContainer: '#1D6E7A',
  onSecondaryDark: '#00363D',
  onSecondaryDarkContainer: '#A3EBF9',
