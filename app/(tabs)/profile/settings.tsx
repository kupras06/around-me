        ...
        <View style={styles.container}>
          ...
          {user?.is_creator ? (
            <>
              <RouteSettingCard
                title="Add New Pin"
                description="Share a new place recommendation"
                onPress={() => {
                  router.push('/creator/submit-pin');
                }}
              />
              <RouteSettingCard
                title="Tag a Post"
                description="Submit a link to your Instagram/Twitter post"
                onPress={() => {
                  router.push('/creator/tag-post');
                }}
              />
              <RouteSettingCard
